...
ExternalClassInstrumenter::ExternalClassInstrumenter( jvmtiEnv *jvmti,
                                                      string javapath,
                                                      string classpath,
                                                      string mainclass,
                                                      string outputFile,
            ...
            case ClassInfo:
                {
                    ...
                    int classId;
                    int superId;
                    int result = sscanf( (const char*) new_bytes,
                                         "C 0x%x %ms 0x%x",
                                         &classId,
                                         &className,
                                         &superId );
...
void ExternalClassInstrumenter::writeUntilDone( SendKind sk,
                                                int fd,
...
unsigned char *ExternalClassInstrumenter::readUntilDone( jvmtiEnv *jvmti,
                                                         int fd,
                                                         RecvKind &kind,
                                                         int &length )
{
...
void ExternalClassInstrumenter::readFully( int fd,
                                           unsigned char *buffer,
                                           int length )
{
    // -- Read until done
...
void ExternalClassInstrumenter::writeFully( int fd,
                                            const unsigned char *buffer,
                                            int length )
{
    // -- Write until done
