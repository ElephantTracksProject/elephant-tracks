...
class FlatTraceOutputter
{
    ...
    private:
        ...
        tbb::atomic<unsigned int> bufferEnd;
        tbb::atomic<unsigned int> deathBufferEnd;
        //How many records have we finished adding to the buffer?
        tbb::atomic <unsigned int> recFinishedCount;
        ...
        tbb::atomic<unsigned int> gcsStarted;
        tbb::atomic<unsigned int> gcsFinished;
